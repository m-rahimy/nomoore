...
public class ScreenGame extends ScreenAdapter implements GestureListener {
	...
	public ScreenGame(MyGdxGame myGdxGame) {
		...
		assetManager.load("music/secretFound.mp3", Sound.class);
		assetManager.load("music/iHavePaintedTheStone.mp3", Sound.class);
		assetManager.load("music/cut.mp3", Sound.class);
		assetManager.load("music/fireIgnited.mp3", Sound.class);
		assetManager.load("music/item_pickup.mp3", Sound.class);

		assetManager.finishLoading();

		musicMainTheme = assetManager.get("music/3_mainTheme.mp3", Music.class);
		musicMainTheme.setLooping(true);

		musicCreepy = assetManager.get("music/creepyDrums.mp3", Music.class);
		musicCreepy.setLooping(true);

		soundSecretFound = assetManager.get("music/secretFound.mp3", Sound.class);
		soundIHavePaintedTheStone = assetManager.get("music/iHavePaintedTheStone.mp3", Sound.class);
		soundCut = assetManager.get("music/cut.mp3", Sound.class);
		soundFireIgnited = assetManager.get("music/fireIgnited.mp3", Sound.class);
		soundItemPickup = assetManager.get("music/item_pickup.mp3", Sound.class);
	...
	public void dispose() {
		...
		soundCut.dispose();
		soundFireIgnited.dispose();
		soundIHavePaintedTheStone.dispose();
		soundSecretFound.dispose();
		...
		if (rectangleLeftHandle.getX() > interactable.getSprite().getX()) {
			if (interactable.equals(rockPainted)) {
				...
				if (hintFoundWhatToDraw) {
					...
					message = "I want to draw, but I do not know what.";
